...
const Navbar = () => {
  ...
  return (
    <div className= {`max-w-screen-2xl dark:bg-slate-800 dark:text-white container mx-auto md:px-20 px-4 fixed top-0 left-0 z-50 right-0 ${
    ...
    <div className="navbar-center hidden lg:flex">
     ...
     <label className={`border p-2 ${sticky && "border-black "}  rounded-lg flex items-center gap-2`}>
...
{auth ? <Logout/>:
    <div >
      <button onClick={()=>document.getElementById("my_modal_3").showModal()} className="bg-black text-white px-3 py-2 hover:bg-slate-900 cursor-pointer duration-300 rounded-lg font-semibold">Login</button>
       <Login/>
    </div>}
  </div>
  </div>
